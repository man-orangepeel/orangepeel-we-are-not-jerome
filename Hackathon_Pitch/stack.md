...
![Tech stack](.gitbook/assets/5-stack.png)
...
The fee must be extracted _before_ sats reach the parent wallet. If the app held funds even briefly, it would be custodial — triggering MiCA CASP obligations (Article 3(1)(15)).
